...
Plugin URI: http://magnetik.org
Description: Can force html edition for a specific page
Version: 0.1
Author: magnetik
...
function force_html_edit_add_custom_box() {
    add_meta_box( 'force-html-edit', __( 'Force html edit', 'myplugin_textdomain' ), 
                'force_html_edit_custom_box', 'post' , 'side');
    add_meta_box( 'force-html-edit', __( 'Force html edit', 'myplugin_textdomain' ), 
                'force_html_edit_custom_box', 'page' , 'side');
}
...
function force_html_edit_custom_box($post) {
  ...
  echo '<label for="force_html_edit">' . __("Force html edit ?", 'myplugin_textdomain' ) . '</label> ';
